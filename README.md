...
- Зайти на страницу с отчетом по ссылке: `http://localhost:8080`
...
- test_data.json - список исходных данных
- test_config.ini - настройки для тестов
- pytest.ini - главный конфигурационный файл для тестов в Pytest
- requirements.txt - список всех небходимых зависимостей
